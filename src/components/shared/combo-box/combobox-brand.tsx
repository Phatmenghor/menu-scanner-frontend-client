...
interface ComboboxSelectedProps {
  dataSelect: BrandModel | null;
  onChangeSelected: (item: BrandModel) => void; // Callback to notify parent about the selection change
  disabled?: boolean;
}
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {dataSelect ? dataSelect.name : "Select a brand..."}
